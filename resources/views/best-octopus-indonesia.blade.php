...
@section('container')
    ...
    <div class="about-area position-relative overflow-hidden overflow-hidden space" id="about-sec">
                    ...
                    <div class="ps-xl-4">
                        ...
                        <ul>
                            <li>Premium Products: All our products are processed to global quality standards and certified
                                internationally.</li>
                            <li>Reliability: We pride ourselves on being a trusted partner, offering timely deliveries and
                        ...
                        <ul>
                            ...
                            <li><b>Mission:</b></li>
                            <ul>
                                <li>To provide high-quality octopus products to customers worldwide.</li>
                                <li>To promote responsible and sustainable fishing practices.</li>
                                <li>To empower local communities, improving their economic well-being.</li>
                            </ul>
                        </ul>
        ...
        <div class="shape-mockup movingX d-none d-xxl-block" data-top="4%" data-left="2%">
            <img src="assets/img/shape/shape_2_1.png" alt="Best Octopus Indonesia" />
        </div>
        <div class="shape-mockup jump d-none d-xxl-block" data-top="28%" data-right="5%">
            <img src="assets/img/shape/shape_2_2.png" alt="Best Octopus Indonesia" />
        </div>
        <div class="shape-mockup spin d-none d-xxl-block" data-bottom="18%" data-left="2%">
            <img src="assets/img/shape/shape_2_3.png" alt="Best Octopus Indonesia" />
        </div>
        <div class="shape-mockup movixgX d-none d-xxl-block" data-bottom="18%" data-right="2%">
            <img src="assets/img/shape/shape_2_4.png" alt="Best Octopus Indonesia" />
        </div>
    </div>
    <div class="about-area position-relative overflow-hidden overflow-hidden space" id="about-sec">
        <div class="container">
                    ...
                    <div class="ps-xl-4">
                        ...
                        <ul>
                            <li><b>Premium Quality Products</b>
                                <p>We ensure that every octopus processed meets the highest standards, from capture to
                                    packaging. Our products are renowned for their freshness, authentic taste, and hygienic
                                    processing methods.</p>
                            </li>
                            <li><b>State-of-the-Art Processing Technology</b>
                                <p>By utilizing modern technology, we guarantee that every step of production adheres to
                                    international standards. This ensures the natural texture, flavor, and nutrients of the
                                    octopus are preserved, making our products ideal for both local and global markets.</p>
                            </li>
                            <li><b>Extensive Market Network</b>
                                <P>With years of experience, we have established strong relationships with trade partners
                                    across Asia, Europe, the Americas, and the Middle East. This enables us to supply
                                    premium-quality octopus products that cater to diverse global market demands.</P>
                            </li>
                            <li><b>Commitment to Sustainability</b>
                                <p>As a company committed to preserving marine resources, we collaborate with local
                                    fishermen to implement sustainable fishing practices. We believe that maintaining
                                    ecosystem balance is key to long-term success</p>
                            </li>
                            <li><b>Support for Local Communities</b>
                                <p>We empower local fishermen and communities by providing training, market access, and
                                    economic support. This not only enhances their quality of life but also ensures a stable
                                    and sustainable octopus supply.</p>
                            </li>
                        </ul>
                        <p>With a focus on innovation, sustainability, and excellence, PT. Gurita Global Internasional is
                            committed to delivering the finest octopus products from Indonesia to the world. Join us on our
                            journey to create a better octopus industry for all.</p>
                        <p>Contact us for more information or partnership opportunities with PT. Gurita Global
                            Internasional!</p>
                    </div>
                </div>
                <div class="col-xl-7">
