...
<head>
    ...
    <!-- SCHEMA JSON-LD: B2B ORGANIZATION & SEAFOOD EXPORTER -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Organization",
      "name": "PT. Gurita Global Internasional",
      "alternateName": ["GGI", "Octopus Indonesia", "Gurita Global International"],
      "url": "https://guritaglobal.com",
      "logo": "https://guritaglobal.com/assets/img/GGILogo.webp",
      "description": "Leading Indonesian seafood processor and exporter specialized in premium frozen wild-caught Octopus Vulgaris and seafood products for international wholesale markets.",
      "address": {
        "@type": "PostalAddress",
    ...
    <style>
        ...
        *,::after,::before{box-sizing:border-box}
        ...
        .hero-brand-line{display:inline-flex;align-items:center;flex-wrap:wrap;gap:15px;margin-bottom:20px}
        .hero-brand-logo{width:125px !important;max-width:125px !important;height:auto !important;max-height:55px !important;display:inline-block !important;background:none !important;padding:0 !important;border:none !important;filter:drop-shadow(0 2px 8px rgba(0,0,0,0.6));vertical-align:middle}
        .hero-badge-pill{display:inline-flex;align-items:center;gap:8px;background:rgba(72,155,66,0.2);border:1px solid rgba(72,155,66,0.5);color:#5be351;padding:7px 18px;border-radius:50px;font-size:12px;font-weight:700;letter-spacing:0.5px;text-transform:uppercase}
            ...
            <div class="container th-container">
                <div class="hero-style-b2b">
                    <div class="hero-brand-line">
                        <img src="/assets/img/GGILogo.webp" alt="PT Gurita Global Internasional - Octopus Indonesia" class="hero-brand-logo" width="125" height="55" style="width: 125px !important; max-width: 125px !important; height: auto !important; max-height: 55px !important; display: inline-block !important; background: transparent !important; padding: 0 !important; border: none !important; box-shadow: none !important;">
