...
<!-- Google tag (gtag.js) - Loaded asynchronously without blocking FCP -->
                ...
                <div class="row justify-content-center justify-content-xl-between align-items-center">
                    ...
                    <div class="col-auto">
                        <div class="header-right">
                            <div class="header-links">
                                <ul>
                                    <li><i class="fa-regular fa-phone"></i> <a href="whatsapp://send?text=Hello&phone=+6281111808661">081 111 808 661</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="container th-container">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto d-none d-xl-block">
                            <div class="header-button"><a href="whatsapp://send?text=Hello&phone=+6281111808661"
                                    class="th-btn style3 th-icon">Call Us Now... !!</a>
                                ...
                                <div class="info-box_text">
                                    ...
                                    <div class="details">
                                        <p>ICS Pelabuhan Perikanan Nusantara Kejawanan, Pegambiran, Kec. Lemahwungkuk,
                                            Kota Cirebon, Jawa Barat 45113</p>
                                    </div>
                                </div>
                            </div>
                        </div>
